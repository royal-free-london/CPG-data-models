...
-- Create a non patient level aggregated version.
...
[Patient_Classification_Desc],
[LOS],
[Length of stay denominator],
[Length of stay numerator],
[Nights_in_hospital],
[DischargeStatus],
[Site_Code_(of_Treatment)_(at_End_of_episode)],
[Primary/Secondary Diagnosis],
[Primary Diagnosis 3d],
[Secondary Diagnosis 1st 3d],
[Primary Procedure],
[SecondaryDiagnosis1-9],
[Primary_Diagnosis_(ICD)],
[Consultant_at_discharge],
Exclude_ZeroNightStay,
Exclude_NonEmergency,
CharlsonCC_Ind,
[Avg Charlson],
...
DiedFlag,
Age_Band_Detailed,
Consultant_at_readmission,
Specialty_Desc_at_readmission,
Primary_Diagnosis_at_readmission,
Readmission_Numerator,
Readmission_Period,
Spell,
Readmission7d,
Readmission30d,
...
from ##SW_HeartFailure_PrimSecDiag_Report
